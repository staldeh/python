    ...
    while True:
        ...
        data2 = {
            ...
            "bme280": {
                ...
                "pressure": environment.get_pressure(),
            },
            "ltr559": {
                "proximity": environment.get_proximity(),
                "lux": environment.get_lux(),
            },
            "gas": {
                "oxidising": environment.get_oxidising(),
                "reducing": environment.get_reducing(),
                "nh3": environment.get_nh3()
            }
        }
        if args.verbose:
            print("Datapoint = " + json.dumps(data))
            print("Datapoint2 = " + json.dumps(data2))

        client.publishEvent("psutil", "json", data)
        client.publishEvent("enviroplus", "json", data2)
